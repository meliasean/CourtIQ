#!/usr/bin/env python3
"""
Score Canada Masters 2026 Final.

RESULT (reported directly by Sean, 2026-08-13):
    Ben Shelton def. Brandon Nakashima  -  Shelton takes the title.

Shelton was the -240 favourite, so the book was right here.

Usage:  python score_canada2026_f.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Ben Shelton", "Brandon Nakashima"): "Ben Shelton",
}
...
print("Scoring Canada Masters 2026 Final...")
score_file(os.path.join(reports, "canada2026_F_predictions.csv"),
           os.path.join(reports, "canada2026_F_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "canada2026_F_predictions_cck.csv"),
                 os.path.join(reports, "canada2026_F_predictions_cck_complete.csv"))
if cck is not None:
