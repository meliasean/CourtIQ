#!/usr/bin/env python3
"""
Score Canada Masters 2026 QF - all 4 matches.

PROVENANCE
----------
Winners DERIVED from the SF pairings (DraftKings, 2026-08-11), not read from
...
Usage:  python score_canada2026_qf.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Daniel Merida", "Learner Tien"):          "Learner Tien",         # 1
    ("Jakub Mensik", "Ben Shelton"):            "Ben Shelton",          # 2
    ("Rafael Jodar", "Arthur Fils"):            "Rafael Jodar",         # 3
    ("Luciano Darderi", "Brandon Nakashima"):   "Brandon Nakashima",    # 4
}
...
print("Scoring Canada Masters 2026 QF (4 matches)...")
score_file(os.path.join(reports, "canada2026_QF_predictions.csv"),
           os.path.join(reports, "canada2026_QF_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "canada2026_QF_predictions_cck.csv"),
                 os.path.join(reports, "canada2026_QF_predictions_cck_complete.csv"))
if cck is not None:
