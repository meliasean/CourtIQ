...
"""
Score Halle 2026 F.
Usage:  python score_halle_f.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Taylor Fritz", "Frances Tiafoe"): "Frances Tiafoe",   # UPSET (Fritz -221)
}
...
print("Scoring Halle 2026 F...")
score_file(os.path.join(reports, "halle2026_F_predictions.csv"),
           os.path.join(reports, "halle2026_F_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "halle2026_F_predictions_cck.csv"),
                 os.path.join(reports, "halle2026_F_predictions_cck_complete.csv"))
if cck is not None:
