#!/usr/bin/env python3
"""
Score Halle 2026 SF. All 2 results inferred from F matchups.
Usage:  python score_halle_sf.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Alexander Zverev", "Taylor Fritz"): "Taylor Fritz",         # UPSET (Zverev -147)
    ("Daniel Altmaier", "Frances Tiafoe"): "Frances Tiafoe",      # chalk (Tiafoe -305)
}
...
print(f"Scoring Halle 2026 SF...")
score_file(os.path.join(reports, "halle2026_SF_predictions.csv"),
           os.path.join(reports, "halle2026_SF_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "halle2026_SF_predictions_cck.csv"),
                 os.path.join(reports, "halle2026_SF_predictions_cck_complete.csv"))
if cck is not None:
