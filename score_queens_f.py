...
"""
Score Queens 2026 F.
Usage:  python score_queens_f.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Francisco Cerundolo", "Tommy Paul"): "Francisco Cerundolo",   # UPSET (Paul -230) — CCK Top Pick LOST
}
...
print("Scoring Queens 2026 F...")
score_file(os.path.join(reports, "queens2026_F_predictions.csv"),
           os.path.join(reports, "queens2026_F_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "queens2026_F_predictions_cck.csv"),
                 os.path.join(reports, "queens2026_F_predictions_cck_complete.csv"))
if cck is not None:
