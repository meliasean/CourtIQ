#!/usr/bin/env python3
"""
Score Queens 2026 SF. All 2 results inferred from F matchups.
Usage:  python score_queens_sf.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Brandon Nakashima", "Francisco Cerundolo"): "Francisco Cerundolo",  # UPSET (Nakashima -183) — CCK pick WON
    ("Tommy Paul", "Ugo Humbert"): "Tommy Paul",                          # CCK Top Pick WON
}
...
print(f"Scoring Queens 2026 SF...")
score_file(os.path.join(reports, "queens2026_SF_predictions.csv"),
           os.path.join(reports, "queens2026_SF_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "queens2026_SF_predictions_cck.csv"),
                 os.path.join(reports, "queens2026_SF_predictions_cck_complete.csv"))
if cck is not None:
