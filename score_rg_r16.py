#!/usr/bin/env python3
"""
Re-score RG 2026 R16 after regenerating predictions.
...
Usage:
    python score_rg_r16.py [reports_dir]   (default: reports)

It reads  rg2026_R16_predictions.csv  and  rg2026_R16_predictions_cck.csv,
...
RESULTS = {
    # === R16 — Day 1 (May 31) ===
    ("Jakub Mensik", "Andrey Rublev"): "Jakub Mensik",
    ("Casper Ruud", "Joao Fonseca"): "Joao Fonseca",                    # UPSET (Ruud -186)
    ("Rafael Jodar", "Pablo Carreno Busta"): "Rafael Jodar",
    ("Jesper de Jong", "Alexander Zverev"): "Alexander Zverev",
    # === R16 — Day 2 (Jun 1) ===
    ("Juan Manuel Cerundolo", "Matteo Berrettini"): "Matteo Berrettini",
    ("Frances Tiafoe", "Matteo Arnaldi"): "Matteo Arnaldi",
    ("Felix Auger Aliassime", "Alejandro Tabilo"): "Felix Auger Aliassime",
    ("Flavio Cobolli", "Zachary Svajda"): "Flavio Cobolli",
}
# ---------------------------------------------------------------------------
...
print("Scoring RG 2026 R16...")
std = score_file(os.path.join(reports, "rg2026_R16_predictions.csv"),
                 os.path.join(reports, "rg2026_R16_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "rg2026_R16_predictions_cck.csv"),
                 os.path.join(reports, "rg2026_R16_predictions_cck_complete.csv"))
