#!/usr/bin/env python3
"""
Score Washington 2026 F. Result reported directly by Sean (2026-08-03), not inferred.
Usage:  python score_washington_f.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Taylor Fritz", "Rafael Jodar"): "Taylor Fritz",
}
...
print("Scoring Washington 2026 F...")
score_file(os.path.join(reports, "washington2026_F_predictions.csv"),
           os.path.join(reports, "washington2026_F_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "washington2026_F_predictions_cck.csv"),
                 os.path.join(reports, "washington2026_F_predictions_cck_complete.csv"))
if cck is not None:
