#!/usr/bin/env python3
"""
Score Washington 2026 QF. All 4 results resolved.
Usage:  python score_washington_qf.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Alex de Minaur", "Brandon Nakashima"): "Brandon Nakashima",
    ("Taylor Fritz", "Alex Michelsen"): "Taylor Fritz",
    ("Rafael Jodar", "Lorenzo Musetti"): "Rafael Jodar",
    ("Alejandro Tabilo", "Ben Shelton"): "Alejandro Tabilo",
}
...
print("Scoring Washington 2026 QF...")
score_file(os.path.join(reports, "washington2026_QF_predictions.csv"),
           os.path.join(reports, "washington2026_QF_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "washington2026_QF_predictions_cck.csv"),
                 os.path.join(reports, "washington2026_QF_predictions_cck_complete.csv"))
if cck is not None:
