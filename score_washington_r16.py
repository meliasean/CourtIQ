#!/usr/bin/env python3
"""
Score Washington 2026 R16. All 8 results resolved.
Usage:  python score_washington_r16.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Alex de Minaur", "Cruz Hewitt"): "Alex de Minaur",
    ("Brandon Nakashima", "Jakub Mensik"): "Brandon Nakashima",
    ("Taylor Fritz", "Kamil Majchrzak"): "Taylor Fritz",
    ("Alex Michelsen", "Adrian Mannarino"): "Alex Michelsen",
    ("Rafael Jodar", "Kei Nishikori"): "Rafael Jodar",
    ("Aleksandar Vukic", "Lorenzo Musetti"): "Lorenzo Musetti",
    ("Terence Atmane", "Alejandro Tabilo"): "Alejandro Tabilo",
    ("Ugo Humbert", "Ben Shelton"): "Ben Shelton",
}
...
print("Scoring Washington 2026 R16...")
score_file(os.path.join(reports, "washington2026_R16_predictions.csv"),
           os.path.join(reports, "washington2026_R16_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "washington2026_R16_predictions_cck.csv"),
                 os.path.join(reports, "washington2026_R16_predictions_cck_complete.csv"))
if cck is not None:
