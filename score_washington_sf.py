#!/usr/bin/env python3
"""
Score Washington 2026 SF. Both results resolved (inferred from Final matchup).
Usage:  python score_washington_sf.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Brandon Nakashima", "Taylor Fritz"): "Taylor Fritz",
    ("Rafael Jodar", "Alejandro Tabilo"): "Rafael Jodar",
}
...
print("Scoring Washington 2026 SF...")
score_file(os.path.join(reports, "washington2026_SF_predictions.csv"),
           os.path.join(reports, "washington2026_SF_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "washington2026_SF_predictions_cck.csv"),
                 os.path.join(reports, "washington2026_SF_predictions_cck_complete.csv"))
if cck is not None:
