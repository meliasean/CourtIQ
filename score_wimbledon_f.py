#!/usr/bin/env python3
"""
Score Wimbledon 2026 Final. Sinner def. Zverev.
Usage:  python score_wimbledon_f.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Jannik Sinner", "Alexander Zverev"): "Jannik Sinner",   # chalk holds
}
...
print("Scoring Wimbledon 2026 Final...")
score_file(os.path.join(reports, "wimbledon2026_F_predictions.csv"),
           os.path.join(reports, "wimbledon2026_F_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "wimbledon2026_F_predictions_cck.csv"),
                 os.path.join(reports, "wimbledon2026_F_predictions_cck_complete.csv"))
if cck is not None:
