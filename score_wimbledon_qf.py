#!/usr/bin/env python3
"""
Score Wimbledon 2026 QF. All 4 results resolved.
Usage:  python score_wimbledon_qf.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Jannik Sinner", "Jan-Lennard Struff"): "Jannik Sinner",
    ("Felix Auger-Aliassime", "Novak Djokovic"): "Novak Djokovic",
    ("Flavio Cobolli", "Arthur Fery"): "Arthur Fery",
    ("Taylor Fritz", "Alexander Zverev"): "Alexander Zverev",
}
...
print("Scoring Wimbledon 2026 QF...")
score_file(os.path.join(reports, "wimbledon2026_QF_predictions.csv"),
           os.path.join(reports, "wimbledon2026_QF_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "wimbledon2026_QF_predictions_cck.csv"),
                 os.path.join(reports, "wimbledon2026_QF_predictions_cck_complete.csv"))
if cck is not None:
