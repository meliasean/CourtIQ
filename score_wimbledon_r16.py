...
RESULTS = {
    ("Jannik Sinner", "Shintaro Mochizuki"): "Jannik Sinner",
    ("Hubert Hurkacz", "Jan-Lennard Struff"): "Jan-Lennard Struff",
    ("Felix Auger-Aliassime", "Alejandro Davidovich Fokina"): "Felix Auger-Aliassime",
    ("Roman Safiullin", "Novak Djokovic"): "Novak Djokovic",
...
print("Scoring Wimbledon 2026 R16...")
score_file(os.path.join(reports, "wimbledon2026_R16_predictions.csv"),
           os.path.join(reports, "wimbledon2026_R16_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "wimbledon2026_R16_predictions_cck.csv"),
                 os.path.join(reports, "wimbledon2026_R16_predictions_cck_complete.csv"))
if cck is not None:
