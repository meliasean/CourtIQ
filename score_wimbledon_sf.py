#!/usr/bin/env python3
"""
Score Wimbledon 2026 SF. Both results resolved (inferred from Final matchup).
Usage:  python score_wimbledon_sf.py [reports_dir]   (default: reports)
"""
import sys, os
import pandas as pd
import unicodedata
...
RESULTS = {
    ("Jannik Sinner", "Novak Djokovic"): "Jannik Sinner",
    ("Arthur Fery", "Alexander Zverev"): "Alexander Zverev",
}
...
print("Scoring Wimbledon 2026 SF...")
score_file(os.path.join(reports, "wimbledon2026_SF_predictions.csv"),
           os.path.join(reports, "wimbledon2026_SF_predictions_complete.csv"))
cck = score_file(os.path.join(reports, "wimbledon2026_SF_predictions_cck.csv"),
                 os.path.join(reports, "wimbledon2026_SF_predictions_cck_complete.csv"))
if cck is not None:
