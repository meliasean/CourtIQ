"""
update_rome2026_sf.py
======================
1. Fills all QF results
2. Generates SF with both matches and odds

QF results:
  Ruud beat Khachanov 2-1     (-435/+333)  May 13
  Darderi beat Jodar 2-1      (+175/-217)  May 13 -- upset
  Medvedev beat Landaluce 2-1 (-303/+250)  May 14
  Sinner beat Rublev 2-0      (-2500/+1400) May 14

SF draw May 15:
  Sinner vs Medvedev  (-1667/+1000)
  Ruud vs Darderi     (-244/+200)

Run:
    python update_rome2026_sf.py
"""
...
QF_RESULTS = [
    # May 13
    ("Casper Ruud",        "Karen Khachanov",    "Casper Ruud",        -435,  333),
    ("Rafael Jodar",       "Luciano Darderi",    "Luciano Darderi",    -217,  175),
    # May 14
    ("Martin Landaluce",   "Daniil Medvedev",    "Daniil Medvedev",     250, -303),
    ("Jannik Sinner",      "Andrey Rublev",      "Jannik Sinner",     -2500, 1400),
]

SF = [
    # Sinner vs Medvedev -- May 15, pending
    ("Jannik Sinner",      "Daniil Medvedev",   -1667, 1000, None, "2026-05-15"),
    # Ruud vs Darderi -- May 15, in progress
    ("Casper Ruud",        "Luciano Darderi",    -244,  200, None, "2026-05-15"),
]


def main():
    print("\n=== Update Rome 2026: QF complete + SF ===\n")
    ...
    print(f"  0 scored, 2 pending")

    print(f"\nDone. Run:")
    print(f"  python courtiq_engine.py site --output docs/index.html")
    print(f"  git add reports/rome2026_QF_*.csv reports/rome2026_SF_*.csv docs/index.html")
    print(f"  git commit -m 'update: Rome QF complete + SF generated'")
    print(f"  git push")
